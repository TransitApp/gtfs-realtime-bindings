...
export const TransitAlertExtension = $root.TransitAlertExtension = (() => {
    ...
    TransitAlertExtension.decode = function decode(reader, length) {
        ...
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.TransitAlertExtension();
    ...
    TransitAlertExtension.fromObject = function fromObject(object) {
        if (object instanceof $root.TransitAlertExtension)
            return object;
        let message = new $root.TransitAlertExtension();
...
export const TransitInformedEntityExtension = $root.TransitInformedEntityExtension = (() => {
    ...
    TransitInformedEntityExtension.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.TransitInformedEntityExtension();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    TransitInformedEntityExtension.fromObject = function fromObject(object) {
        if (object instanceof $root.TransitInformedEntityExtension)
            return object;
        let message = new $root.TransitInformedEntityExtension();
...
export const TransitVehicleDescriptorExtension = $root.TransitVehicleDescriptorExtension = (() => {
    ...
    TransitVehicleDescriptorExtension.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.TransitVehicleDescriptorExtension();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    TransitVehicleDescriptorExtension.fromObject = function fromObject(object) {
        if (object instanceof $root.TransitVehicleDescriptorExtension)
            return object;
        let message = new $root.TransitVehicleDescriptorExtension();
...
export const TransitTripDescriptorExtension = $root.TransitTripDescriptorExtension = (() => {
    ...
    TransitTripDescriptorExtension.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.TransitTripDescriptorExtension();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    TransitTripDescriptorExtension.fromObject = function fromObject(object) {
        if (object instanceof $root.TransitTripDescriptorExtension)
            return object;
        let message = new $root.TransitTripDescriptorExtension();
...
export const TransitStopTimeUpdateExtension = $root.TransitStopTimeUpdateExtension = (() => {
    ...
    TransitStopTimeUpdateExtension.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.TransitStopTimeUpdateExtension();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    TransitStopTimeUpdateExtension.fromObject = function fromObject(object) {
        if (object instanceof $root.TransitStopTimeUpdateExtension)
            return object;
        let message = new $root.TransitStopTimeUpdateExtension();
...
export const TransitModificationExtension = $root.TransitModificationExtension = (() => {
    ...
    TransitModificationExtension.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.TransitModificationExtension();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    TransitModificationExtension.fromObject = function fromObject(object) {
        if (object instanceof $root.TransitModificationExtension)
            return object;
        let message = new $root.TransitModificationExtension();
        if (object.tripIds) {
...
export const TransitReplacementStopExtension = $root.TransitReplacementStopExtension = (() => {

    /**
     * Properties of a TransitReplacementStopExtension.
     * @exports ITransitReplacementStopExtension
     * @interface ITransitReplacementStopExtension
     * @property {boolean} noThroughTravel TransitReplacementStopExtension noThroughTravel
     * @property {string} nextShapeId TransitReplacementStopExtension nextShapeId
     */

    /**
     * Constructs a new TransitReplacementStopExtension.
     * @exports TransitReplacementStopExtension
     * @classdesc Represents a TransitReplacementStopExtension.
     * @implements ITransitReplacementStopExtension
     * @constructor
     * @param {ITransitReplacementStopExtension=} [properties] Properties to set
     */
    function TransitReplacementStopExtension(properties) {
        if (properties)
            for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
                    this[keys[i]] = properties[keys[i]];
     ...
     * @member {boolean} noThroughTravel
     * @memberof TransitReplacementStopExtension
     * @instance
     */
    TransitReplacementStopExtension.prototype.noThroughTravel = false;

    /**
     * TransitReplacementStopExtension nextShapeId.
     * @member {string} nextShapeId
     * @memberof TransitReplacementStopExtension
     * @instance
     */
    TransitReplacementStopExtension.prototype.nextShapeId = "";
     ...
     * @static
     * @param {ITransitReplacementStopExtension=} [properties] Properties to set
     * @returns {TransitReplacementStopExtension} TransitReplacementStopExtension instance
     */
    TransitReplacementStopExtension.create = function create(properties) {
        return new TransitReplacementStopExtension(properties);
    };
     ...
     * @memberof TransitReplacementStopExtension
     * @static
     * @param {ITransitReplacementStopExtension} message TransitReplacementStopExtension message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    TransitReplacementStopExtension.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        writer.uint32(/* id 1, wireType 0 =*/8).bool(message.noThroughTravel);
        writer.uint32(/* id 2, wireType 2 =*/18).string(message.nextShapeId);
        return writer;
    };
     ...
     * @returns {$protobuf.Writer} Writer
     */
    TransitReplacementStopExtension.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {TransitReplacementStopExtension} TransitReplacementStopExtension
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    TransitReplacementStopExtension.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.TransitReplacementStopExtension();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
                    message.noThroughTravel = reader.bool();
                    break;
                }
            case 2: {
                    message.nextShapeId = reader.string();
                    break;
                }
            default:
                reader.skipType(tag & 7);
        ...
        if (!message.hasOwnProperty("noThroughTravel"))
            throw $util.ProtocolError("missing required 'noThroughTravel'", { instance: message });
        if (!message.hasOwnProperty("nextShapeId"))
            throw $util.ProtocolError("missing required 'nextShapeId'", { instance: message });
        return message;
    };
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    TransitReplacementStopExtension.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    TransitReplacementStopExtension.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (typeof message.noThroughTravel !== "boolean")
            return "noThroughTravel: boolean expected";
        if (!$util.isString(message.nextShapeId))
            return "nextShapeId: string expected";
        return null;
    };
     ...
     * @returns {TransitReplacementStopExtension} TransitReplacementStopExtension
     */
    TransitReplacementStopExtension.fromObject = function fromObject(object) {
        if (object instanceof $root.TransitReplacementStopExtension)
            return object;
        let message = new $root.TransitReplacementStopExtension();
        if (object.noThroughTravel != null)
            message.noThroughTravel = Boolean(object.noThroughTravel);
        if (object.nextShapeId != null)
            message.nextShapeId = String(object.nextShapeId);
        return message;
    };
     ...
     * @memberof TransitReplacementStopExtension
     * @static
     * @param {TransitReplacementStopExtension} message TransitReplacementStopExtension
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    TransitReplacementStopExtension.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        let object = {};
        if (options.defaults) {
            object.noThroughTravel = false;
            object.nextShapeId = "";
        }
        if (message.noThroughTravel != null && message.hasOwnProperty("noThroughTravel"))
            object.noThroughTravel = message.noThroughTravel;
        if (message.nextShapeId != null && message.hasOwnProperty("nextShapeId"))
            object.nextShapeId = message.nextShapeId;
        return object;
    };
     ...
     * @returns {Object.<string,*>} JSON object
     */
    TransitReplacementStopExtension.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
     ...
     * @returns {string} The default type url
     */
    TransitReplacementStopExtension.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
            typeUrlPrefix = "type.googleapis.com";
        }
        return typeUrlPrefix + "/TransitReplacementStopExtension";
    };

    return TransitReplacementStopExtension;
})();

export const TransitModifiedTripSelector = $root.TransitModifiedTripSelector = (() => {

    /**
     * Properties of a TransitModifiedTripSelector.
     * @exports ITransitModifiedTripSelector
     * @interface ITransitModifiedTripSelector
     * @property {number|null} [splitServiceSegmentIndex] TransitModifiedTripSelector splitServiceSegmentIndex
     */

    /**
     * Constructs a new TransitModifiedTripSelector.
     * @exports TransitModifiedTripSelector
     * @classdesc Represents a TransitModifiedTripSelector.
     * @implements ITransitModifiedTripSelector
     * @constructor
     * @param {ITransitModifiedTripSelector=} [properties] Properties to set
     */
    function TransitModifiedTripSelector(properties) {
        if (properties)
            for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
                    this[keys[i]] = properties[keys[i]];
     ...
     * @member {number} splitServiceSegmentIndex
     * @memberof TransitModifiedTripSelector
     * @instance
     */
    TransitModifiedTripSelector.prototype.splitServiceSegmentIndex = 0;
     ...
     * @static
     * @param {ITransitModifiedTripSelector=} [properties] Properties to set
     * @returns {TransitModifiedTripSelector} TransitModifiedTripSelector instance
     */
    TransitModifiedTripSelector.create = function create(properties) {
        return new TransitModifiedTripSelector(properties);
    };
     ...
     * @memberof TransitModifiedTripSelector
     * @static
     * @param {ITransitModifiedTripSelector} message TransitModifiedTripSelector message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    TransitModifiedTripSelector.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        if (message.splitServiceSegmentIndex != null && Object.hasOwnProperty.call(message, "splitServiceSegmentIndex"))
            writer.uint32(/* id 1, wireType 0 =*/8).int32(message.splitServiceSegmentIndex);
        return writer;
    };
     ...
     * @returns {$protobuf.Writer} Writer
     */
    TransitModifiedTripSelector.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {TransitModifiedTripSelector} TransitModifiedTripSelector
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    TransitModifiedTripSelector.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.TransitModifiedTripSelector();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
                    message.splitServiceSegmentIndex = reader.int32();
                    break;
                }
            default:
                reader.skipType(tag & 7);
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    TransitModifiedTripSelector.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    TransitModifiedTripSelector.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.splitServiceSegmentIndex != null && message.hasOwnProperty("splitServiceSegmentIndex"))
            if (!$util.isInteger(message.splitServiceSegmentIndex))
                return "splitServiceSegmentIndex: integer expected";
        return null;
    };
     ...
     * @returns {TransitModifiedTripSelector} TransitModifiedTripSelector
     */
    TransitModifiedTripSelector.fromObject = function fromObject(object) {
        if (object instanceof $root.TransitModifiedTripSelector)
            return object;
        let message = new $root.TransitModifiedTripSelector();
        if (object.splitServiceSegmentIndex != null)
            message.splitServiceSegmentIndex = object.splitServiceSegmentIndex | 0;
        return message;
    };
     ...
     * @memberof TransitModifiedTripSelector
     * @static
     * @param {TransitModifiedTripSelector} message TransitModifiedTripSelector
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    TransitModifiedTripSelector.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        let object = {};
        if (options.defaults)
            object.splitServiceSegmentIndex = 0;
        if (message.splitServiceSegmentIndex != null && message.hasOwnProperty("splitServiceSegmentIndex"))
            object.splitServiceSegmentIndex = message.splitServiceSegmentIndex;
        return object;
    };
     ...
     * @returns {Object.<string,*>} JSON object
     */
    TransitModifiedTripSelector.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
     ...
     * @returns {string} The default type url
     */
    TransitModifiedTripSelector.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
            typeUrlPrefix = "type.googleapis.com";
        }
        return typeUrlPrefix + "/TransitModifiedTripSelector";
    };

    return TransitModifiedTripSelector;
})();
...
export const transit_realtime = $root.transit_realtime = (() => {
    ...
    transit_realtime.FeedHeader = (function() {
        ...
        FeedHeader.verify = function verify(message) {
            ...
            if (message[".nyctFeedHeader"] != null && message.hasOwnProperty(".nyctFeedHeader")) {
                let error = $root.NyctFeedHeader.verify(message[".nyctFeedHeader"]);
                if (error)
        ...
        TripUpdate.StopTimeUpdate = (function() {
            ...
            StopTimeUpdate.verify = function verify(message) {
                ...
                if (message[".transitStopTimeUpdateExtension"] != null && message.hasOwnProperty(".transitStopTimeUpdateExtension")) {
                    let error = $root.TransitStopTimeUpdateExtension.verify(message[".transitStopTimeUpdateExtension"]);
                    if (error)
    ...
    transit_realtime.Alert = (function() {
        ...
        Alert.verify = function verify(message) {
            ...
            if (message[".transitAlertExtension"] != null && message.hasOwnProperty(".transitAlertExtension")) {
                let error = $root.TransitAlertExtension.verify(message[".transitAlertExtension"]);
                if (error)
                    return ".transitAlertExtension." + error;
            }
            if (message[".mercuryAlert"] != null && message.hasOwnProperty(".mercuryAlert")) {
                let error = $root.MercuryAlert.verify(message[".mercuryAlert"]);
                if (error)
    ...
    transit_realtime.TripDescriptor = (function() {
        ...
        TripDescriptor.verify = function verify(message) {
            ...
            if (message[".transitTripDescriptorExtension"] != null && message.hasOwnProperty(".transitTripDescriptorExtension")) {
                let error = $root.TransitTripDescriptorExtension.verify(message[".transitTripDescriptorExtension"]);
                if (error)
                    return ".transitTripDescriptorExtension." + error;
            }
            if (message[".nyctTripDescriptor"] != null && message.hasOwnProperty(".nyctTripDescriptor")) {
                let error = $root.NyctTripDescriptor.verify(message[".nyctTripDescriptor"]);
                if (error)
        ...
        TripDescriptor.ModifiedTripSelector = (function() {
             ...
             * @property {ITransitModifiedTripSelector|null} [".transitModifiedTripSelectorExtension"] ModifiedTripSelector .transitModifiedTripSelectorExtension
             */
             ...
             * @member {ITransitModifiedTripSelector|null|undefined} .transitModifiedTripSelectorExtension
             * @memberof transit_realtime.TripDescriptor.ModifiedTripSelector
             * @instance
             */
            ModifiedTripSelector.prototype[".transitModifiedTripSelectorExtension"] = null;
            ...
            ModifiedTripSelector.encode = function encode(message, writer) {
                ...
                if (message[".transitModifiedTripSelectorExtension"] != null && Object.hasOwnProperty.call(message, ".transitModifiedTripSelectorExtension"))
                    $root.TransitModifiedTripSelector.encode(message[".transitModifiedTripSelectorExtension"], writer.uint32(/* id 9514, wireType 2 =*/76114).fork()).ldelim();
                return writer;
            };
            ...
            ModifiedTripSelector.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 9514: {
                            message[".transitModifiedTripSelectorExtension"] = $root.TransitModifiedTripSelector.decode(reader, reader.uint32());
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            ModifiedTripSelector.verify = function verify(message) {
                ...
                if (message.startDate != null && message.hasOwnProperty("startDate"))
                    if (!$util.isString(message.startDate))
                        return "startDate: string expected";
                if (message[".transitModifiedTripSelectorExtension"] != null && message.hasOwnProperty(".transitModifiedTripSelectorExtension")) {
                    let error = $root.TransitModifiedTripSelector.verify(message[".transitModifiedTripSelectorExtension"]);
                    if (error)
                        return ".transitModifiedTripSelectorExtension." + error;
                }
                return null;
            };
            ...
            ModifiedTripSelector.fromObject = function fromObject(object) {
                ...
                if (object.startDate != null)
                    message.startDate = String(object.startDate);
                if (object[".transitModifiedTripSelectorExtension"] != null) {
                    if (typeof object[".transitModifiedTripSelectorExtension"] !== "object")
                        throw TypeError(".transit_realtime.TripDescriptor.ModifiedTripSelector..transitModifiedTripSelectorExtension: object expected");
                    message[".transitModifiedTripSelectorExtension"] = $root.TransitModifiedTripSelector.fromObject(object[".transitModifiedTripSelectorExtension"]);
                }
                return message;
            };
            ...
            ModifiedTripSelector.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    object.startTime = "";
                    object.startDate = "";
                    object[".transitModifiedTripSelectorExtension"] = null;
                }
                if (message.modificationsId != null && message.hasOwnProperty("modificationsId"))
                ...
                if (message.startDate != null && message.hasOwnProperty("startDate"))
                    object.startDate = message.startDate;
                if (message[".transitModifiedTripSelectorExtension"] != null && message.hasOwnProperty(".transitModifiedTripSelectorExtension"))
                    object[".transitModifiedTripSelectorExtension"] = $root.TransitModifiedTripSelector.toObject(message[".transitModifiedTripSelectorExtension"], options);
                return object;
            };
    ...
    transit_realtime.VehicleDescriptor = (function() {
        ...
        VehicleDescriptor.verify = function verify(message) {
            ...
            if (message[".transitVehicleDescriptorExtension"] != null && message.hasOwnProperty(".transitVehicleDescriptorExtension")) {
                let error = $root.TransitVehicleDescriptorExtension.verify(message[".transitVehicleDescriptorExtension"]);
                if (error)
            ...
            if (message[".tfnswVehicleDescriptor"] != null && message.hasOwnProperty(".tfnswVehicleDescriptor")) {
                let error = $root.TfnswVehicleDescriptor.verify(message[".tfnswVehicleDescriptor"]);
                if (error)
    ...
    transit_realtime.EntitySelector = (function() {
        ...
        EntitySelector.verify = function verify(message) {
            ...
            if (message[".transitEntitySelectorExtension"] != null && message.hasOwnProperty(".transitEntitySelectorExtension")) {
                let error = $root.TransitInformedEntityExtension.verify(message[".transitEntitySelectorExtension"]);
                if (error)
            ...
            if (message[".mercuryEntitySelector"] != null && message.hasOwnProperty(".mercuryEntitySelector")) {
                let error = $root.MercuryEntitySelector.verify(message[".mercuryEntitySelector"]);
                if (error)
        ...
        TripModifications.Modification = (function() {
            ...
            Modification.verify = function verify(message) {
                ...
                if (message[".transitModificationExtension"] != null && message.hasOwnProperty(".transitModificationExtension")) {
                    let error = $root.TransitModificationExtension.verify(message[".transitModificationExtension"]);
                    if (error)
    ...
    transit_realtime.ReplacementStop = (function() {
         ...
         * @property {ITransitReplacementStopExtension|null} [".transitReplacementStopExtension"] ReplacementStop .transitReplacementStopExtension
         */
         ...
         * @member {ITransitReplacementStopExtension|null|undefined} .transitReplacementStopExtension
         * @memberof transit_realtime.ReplacementStop
         * @instance
         */
        ReplacementStop.prototype[".transitReplacementStopExtension"] = null;
        ...
        ReplacementStop.encode = function encode(message, writer) {
            ...
            if (message.stopId != null && Object.hasOwnProperty.call(message, "stopId"))
                writer.uint32(/* id 2, wireType 2 =*/18).string(message.stopId);
            if (message[".transitReplacementStopExtension"] != null && Object.hasOwnProperty.call(message, ".transitReplacementStopExtension"))
                $root.TransitReplacementStopExtension.encode(message[".transitReplacementStopExtension"], writer.uint32(/* id 9514, wireType 2 =*/76114).fork()).ldelim();
            return writer;
        };
        ...
        ReplacementStop.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
                ...
                case 9514: {
                        message[".transitReplacementStopExtension"] = $root.TransitReplacementStopExtension.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        ReplacementStop.verify = function verify(message) {
            ...
            if (message.stopId != null && message.hasOwnProperty("stopId"))
                if (!$util.isString(message.stopId))
                    return "stopId: string expected";
            if (message[".transitReplacementStopExtension"] != null && message.hasOwnProperty(".transitReplacementStopExtension")) {
                let error = $root.TransitReplacementStopExtension.verify(message[".transitReplacementStopExtension"]);
                if (error)
                    return ".transitReplacementStopExtension." + error;
            }
            return null;
        };
        ...
        ReplacementStop.fromObject = function fromObject(object) {
            ...
            if (object.stopId != null)
                message.stopId = String(object.stopId);
            if (object[".transitReplacementStopExtension"] != null) {
                if (typeof object[".transitReplacementStopExtension"] !== "object")
                    throw TypeError(".transit_realtime.ReplacementStop..transitReplacementStopExtension: object expected");
                message[".transitReplacementStopExtension"] = $root.TransitReplacementStopExtension.fromObject(object[".transitReplacementStopExtension"]);
            }
            return message;
        };
        ...
        ReplacementStop.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                object.stopId = "";
                object[".transitReplacementStopExtension"] = null;
            }
            if (message.travelTimeToStop != null && message.hasOwnProperty("travelTimeToStop"))
            ...
            if (message.stopId != null && message.hasOwnProperty("stopId"))
                object.stopId = message.stopId;
            if (message[".transitReplacementStopExtension"] != null && message.hasOwnProperty(".transitReplacementStopExtension"))
                object[".transitReplacementStopExtension"] = $root.TransitReplacementStopExtension.toObject(message[".transitReplacementStopExtension"], options);
            return object;
        };
...
export const TfnswVehicleDescriptor = $root.TfnswVehicleDescriptor = (() => {
    ...
    TfnswVehicleDescriptor.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.TfnswVehicleDescriptor();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    TfnswVehicleDescriptor.fromObject = function fromObject(object) {
        if (object instanceof $root.TfnswVehicleDescriptor)
            return object;
        let message = new $root.TfnswVehicleDescriptor();
...
export const TripReplacementPeriod = $root.TripReplacementPeriod = (() => {
    ...
    TripReplacementPeriod.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.TripReplacementPeriod();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
...
export const NyctFeedHeader = $root.NyctFeedHeader = (() => {
    ...
    NyctFeedHeader.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.NyctFeedHeader();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    NyctFeedHeader.verify = function verify(message) {
        ...
        if (message.tripReplacementPeriod != null && message.hasOwnProperty("tripReplacementPeriod")) {
            ...
            for (let i = 0; i < message.tripReplacementPeriod.length; ++i) {
                let error = $root.TripReplacementPeriod.verify(message.tripReplacementPeriod[i]);
                if (error)
...
export const NyctTripDescriptor = $root.NyctTripDescriptor = (() => {
    ...
    NyctTripDescriptor.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.NyctTripDescriptor();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
...
export const NyctStopTimeUpdate = $root.NyctStopTimeUpdate = (() => {
    ...
    NyctStopTimeUpdate.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.NyctStopTimeUpdate();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
...
export const MercuryFeedHeader = $root.MercuryFeedHeader = (() => {
    ...
    MercuryFeedHeader.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.MercuryFeedHeader();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    MercuryFeedHeader.fromObject = function fromObject(object) {
        if (object instanceof $root.MercuryFeedHeader)
            return object;
        let message = new $root.MercuryFeedHeader();
...
export const MercuryStationAlternative = $root.MercuryStationAlternative = (() => {
    ...
    MercuryStationAlternative.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.MercuryStationAlternative();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    MercuryStationAlternative.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        {
            let error = $root.transit_realtime.EntitySelector.verify(message.affectedEntity);
            if (error)
                return "affectedEntity." + error;
        }
        {
            let error = $root.transit_realtime.TranslatedString.verify(message.notes);
            if (error)
                return "notes." + error;
        }
        return null;
    ...
    MercuryStationAlternative.fromObject = function fromObject(object) {
        if (object instanceof $root.MercuryStationAlternative)
            return object;
        let message = new $root.MercuryStationAlternative();
...
export const MercuryAlert = $root.MercuryAlert = (() => {
    ...
    MercuryAlert.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.MercuryAlert();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    MercuryAlert.verify = function verify(message) {
        ...
        if (message.stationAlternative != null && message.hasOwnProperty("stationAlternative")) {
            ...
            for (let i = 0; i < message.stationAlternative.length; ++i) {
                let error = $root.MercuryStationAlternative.verify(message.stationAlternative[i]);
                if (error)
        ...
        if (message.humanReadableActivePeriod != null && message.hasOwnProperty("humanReadableActivePeriod")) {
            let error = $root.transit_realtime.TranslatedString.verify(message.humanReadableActivePeriod);
            if (error)
        ...
        if (message.affectedStations != null && message.hasOwnProperty("affectedStations")) {
            ...
            for (let i = 0; i < message.affectedStations.length; ++i) {
                let error = $root.transit_realtime.EntitySelector.verify(message.affectedStations[i]);
                if (error)
                    return "affectedStations." + error;
            }
        }
        if (message.screensSummary != null && message.hasOwnProperty("screensSummary")) {
            let error = $root.transit_realtime.TranslatedString.verify(message.screensSummary);
            if (error)
    ...
    MercuryAlert.fromObject = function fromObject(object) {
        if (object instanceof $root.MercuryAlert)
            return object;
        let message = new $root.MercuryAlert();
        if (object.createdAt != null)
            if ($util.Long)
                (message.createdAt = $util.Long.fromValue(object.createdAt)).unsigned = true;
            else if (typeof object.createdAt === "string")
...
export const MercuryEntitySelector = $root.MercuryEntitySelector = (() => {
    ...
    MercuryEntitySelector.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.MercuryEntitySelector();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    MercuryEntitySelector.fromObject = function fromObject(object) {
        if (object instanceof $root.MercuryEntitySelector)
            return object;
        let message = new $root.MercuryEntitySelector();
